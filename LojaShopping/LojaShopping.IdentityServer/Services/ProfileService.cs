...
namespace LojaShopping.IdentityServer.Services
{
    public class ProfileService : IProfileService
    {
        ...
        public async Task GetProfileDataAsync(ProfileDataRequestContext context)
        {
            ...
            claims.Add(new Claim(JwtClaimTypes.FamilyName, user.PrimeiroNome));
            claims.Add(new Claim(JwtClaimTypes.GivenName, user.UltimoNome));
